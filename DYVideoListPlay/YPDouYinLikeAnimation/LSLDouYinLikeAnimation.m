//
//  LSLDouYinLikeAnimation.m
//  LSLDouYinLikeAnimationDemo
//
//  Created by LiShuangLong on 2018/7/18.
//  Copyright © 2018年 Work_Zyp. All rights reserved.
//
#import "LSLDouYinLikeAnimation.h"

//---------------------------------------------私有定制·配置区
/** ❤️形图片的名字*/
NSString *const lsl_heartImgName = @"lsl_video_like";
/** ❤️形图片的宽度*/
const CGFloat lsl_heartImgWidth = 80;
/** ❤️形图片的高度*/
const CGFloat lsl_heartImgHeight = 80;
//---------------------------------------------私有定制·配置区


@interface LSLDouYinLikeAnimation ()


@end

@implementation LSLDouYinLikeAnimation

#pragma mark -
#pragma mark - 🎱 shareInstance 多线程单例
+ (instancetype)shareInstance {
    static LSLDouYinLikeAnimation *selfInstance = nil;
...
- (void)createAnimationWithTouch:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    UIImage *img = [UIImage imageNamed:lsl_heartImgName];
    UIImageView *imgV = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, lsl_heartImgWidth, lsl_heartImgHeight)];
    imgV.image = img;
